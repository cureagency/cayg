<div class="container <?php the_sub_field('top_margin'); ?>-top-margin <?php the_sub_field('bottom_margin'); ?>-bottom-margin small-topandbottom-padding" id="<?php the_sub_field('anchor_link'); ?>">
            ...
            <div class="row row-eq-height">
               ...
               <?php while( $custom_query->have_posts() ) : $custom_query->the_post(); ?>
                    ...
                    <div class="col-lg-6">
                        <div class="team-card small-bottom-margin">
                            <div class="row">
                                <div class="col">
                                    <?php $thumb = get_the_post_thumbnail_url(); ?>
                                    <div class="blog-card-image background-image" style="background-image: url('<?php echo $thumb;?>')">
                            ...
                            <div class="row small-top-margin">
                                ...
                                <div class="col-10">
                                    <article <?php post_class(); ?>>
                                        ...
                                        <p class="small-bottom-margin"><?php the_time('F jS, Y') ?></p>
